...
//
// code for type `MsgMetadata`
//

int MsgMetadata::check_tag(const vm::CellSlice& cs) const {
  return cs.prefetch_ulong(4) == 0 ? msg_metadata : -1;
}

bool MsgMetadata::skip(vm::CellSlice& cs) const {
  return cs.advance(36)
      && t_MsgAddressInt.skip(cs)
      && cs.advance(64);
}

bool MsgMetadata::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
...
bool MsgMetadata::unpack(vm::CellSlice& cs, MsgMetadata::Record& data) const {
  return cs.fetch_ulong(4) == 0
      && cs.fetch_uint_to(32, data.depth)
      && t_MsgAddressInt.fetch_to(cs, data.initiator_addr)
      && cs.fetch_uint_to(64, data.initiator_lt);
}

bool MsgMetadata::unpack_msg_metadata(vm::CellSlice& cs, unsigned& depth, Ref<CellSlice>& initiator_addr, unsigned long long& initiator_lt) const {
  return cs.fetch_ulong(4) == 0
      && cs.fetch_uint_to(32, depth)
      && t_MsgAddressInt.fetch_to(cs, initiator_addr)
      && cs.fetch_uint_to(64, initiator_lt);
}

bool MsgMetadata::cell_unpack(Ref<vm::Cell> cell_ref, MsgMetadata::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool MsgMetadata::cell_unpack_msg_metadata(Ref<vm::Cell> cell_ref, unsigned& depth, Ref<CellSlice>& initiator_addr, unsigned long long& initiator_lt) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_msg_metadata(cs, depth, initiator_addr, initiator_lt) && cs.empty_ext();
}

bool MsgMetadata::pack(vm::CellBuilder& cb, const MsgMetadata::Record& data) const {
  return cb.store_long_bool(0, 4)
      && cb.store_ulong_rchk_bool(data.depth, 32)
      && t_MsgAddressInt.store_from(cb, data.initiator_addr)
      && cb.store_ulong_rchk_bool(data.initiator_lt, 64);
}

bool MsgMetadata::pack_msg_metadata(vm::CellBuilder& cb, unsigned depth, Ref<CellSlice> initiator_addr, unsigned long long initiator_lt) const {
  return cb.store_long_bool(0, 4)
      && cb.store_ulong_rchk_bool(depth, 32)
      && t_MsgAddressInt.store_from(cb, initiator_addr)
      && cb.store_ulong_rchk_bool(initiator_lt, 64);
}

bool MsgMetadata::cell_pack(Ref<vm::Cell>& cell_ref, const MsgMetadata::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool MsgMetadata::cell_pack_msg_metadata(Ref<vm::Cell>& cell_ref, unsigned depth, Ref<CellSlice> initiator_addr, unsigned long long initiator_lt) const {
  vm::CellBuilder cb;
  return pack_msg_metadata(cb, depth, std::move(initiator_addr), initiator_lt) && std::move(cb).finalize_to(cell_ref);
}

bool MsgMetadata::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return cs.fetch_ulong(4) == 0
      && pp.open("msg_metadata")
      && pp.fetch_uint_field(cs, 32, "depth")
      && pp.field("initiator_addr")
      && t_MsgAddressInt.print_skip(pp, cs)
      && pp.fetch_uint_field(cs, 64, "initiator_lt")
      && pp.close();
}

const MsgMetadata t_MsgMetadata;

//
// code for type `MsgEnvelope`
//
constexpr unsigned char MsgEnvelope::cons_tag[2];

int MsgEnvelope::check_tag(const vm::CellSlice& cs) const {
  switch (get_tag(cs)) {
  case msg_envelope:
    return cs.have(4) ? msg_envelope : -1;
  case msg_envelope_v2:
    return cs.prefetch_ulong(4) == 5 ? msg_envelope_v2 : -1;
  }
  return -1;
}
...
bool MsgEnvelope::skip(vm::CellSlice& cs) const {
  ...
  case msg_envelope_v2:
    return cs.advance(4)
        ...
        && t_Grams.skip(cs)
        && cs.advance_refs(1)
        && t_Maybe_uint64.skip(cs)
        && t_Maybe_MsgMetadata.skip(cs);
  }
  return false;
}
...
bool MsgEnvelope::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  ...
  case msg_envelope_v2:
    return cs.fetch_ulong(4) == 5
        ...
        && t_Grams.validate_skip(ops, cs, weak)
        && t_Message_Any.validate_skip_ref(ops, cs, weak)
        && t_Maybe_uint64.validate_skip(ops, cs, weak)
        && t_Maybe_MsgMetadata.validate_skip(ops, cs, weak);
  }
  return false;
}

bool MsgEnvelope::unpack(vm::CellSlice& cs, MsgEnvelope::Record_msg_envelope& data) const {
...
bool MsgEnvelope::cell_unpack(Ref<vm::Cell> cell_ref, MsgEnvelope::Record_msg_envelope& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool MsgEnvelope::unpack(vm::CellSlice& cs, MsgEnvelope::Record_msg_envelope_v2& data) const {
  return cs.fetch_ulong(4) == 5
      && t_IntermediateAddress.fetch_to(cs, data.cur_addr)
      && t_IntermediateAddress.fetch_to(cs, data.next_addr)
      && t_Grams.fetch_to(cs, data.fwd_fee_remaining)
      && cs.fetch_ref_to(data.msg)
      && t_Maybe_uint64.fetch_to(cs, data.emitted_lt)
      && t_Maybe_MsgMetadata.fetch_to(cs, data.metadata);
}

bool MsgEnvelope::cell_unpack(Ref<vm::Cell> cell_ref, MsgEnvelope::Record_msg_envelope_v2& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool MsgEnvelope::pack(vm::CellBuilder& cb, const MsgEnvelope::Record_msg_envelope& data) const {
...
bool MsgEnvelope::cell_pack(Ref<vm::Cell>& cell_ref, const MsgEnvelope::Record_msg_envelope& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool MsgEnvelope::pack(vm::CellBuilder& cb, const MsgEnvelope::Record_msg_envelope_v2& data) const {
  return cb.store_long_bool(5, 4)
      && t_IntermediateAddress.store_from(cb, data.cur_addr)
      && t_IntermediateAddress.store_from(cb, data.next_addr)
      && t_Grams.store_from(cb, data.fwd_fee_remaining)
      && cb.store_ref_bool(data.msg)
      && t_Maybe_uint64.store_from(cb, data.emitted_lt)
      && t_Maybe_MsgMetadata.store_from(cb, data.metadata);
}

bool MsgEnvelope::cell_pack(Ref<vm::Cell>& cell_ref, const MsgEnvelope::Record_msg_envelope_v2& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}
...
bool MsgEnvelope::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  ...
  case msg_envelope_v2:
    return cs.fetch_ulong(4) == 5
        ...
        && t_Message_Any.print_ref(pp, cs.fetch_ref())
        && pp.field("emitted_lt")
        && t_Maybe_uint64.print_skip(pp, cs)
        && pp.field("metadata")
        && t_Maybe_MsgMetadata.print_skip(pp, cs)
        && pp.close();
  }
  return pp.fail("unknown constructor for MsgEnvelope");
}
...
// code for type `InMsg`
//
constexpr char InMsg::cons_len[9];
constexpr unsigned char InMsg::cons_tag[9];

int InMsg::check_tag(const vm::CellSlice& cs) const {
  switch (get_tag(cs)) {
  case msg_import_ext:
    return cs.have(3) ? msg_import_ext : -1;
  case msg_import_ihr:
  ...
  case msg_import_deferred_fin:
    return cs.have(5) ? msg_import_deferred_fin : -1;
  case msg_import_deferred_tr:
    return cs.prefetch_ulong(5) == 5 ? msg_import_deferred_tr : -1;
  }
  return -1;
}
...
bool InMsg::unpack(vm::CellSlice& cs, InMsg::Record_msg_import_deferred_fin& data) const {
  return cs.fetch_ulong(5) == 4
      && cs.fetch_ref_to(data.in_msg)
      && cs.fetch_ref_to(data.transaction)
      && t_Grams.fetch_to(cs, data.fwd_fee);
}

bool InMsg::unpack_msg_import_deferred_fin(vm::CellSlice& cs, Ref<Cell>& in_msg, Ref<Cell>& transaction, Ref<CellSlice>& fwd_fee) const {
  return cs.fetch_ulong(5) == 4
      && cs.fetch_ref_to(in_msg)
      && cs.fetch_ref_to(transaction)
      && t_Grams.fetch_to(cs, fwd_fee);
...
bool InMsg::cell_unpack(Ref<vm::Cell> cell_ref, InMsg::Record_msg_import_deferred_fin& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool InMsg::cell_unpack_msg_import_deferred_fin(Ref<vm::Cell> cell_ref, Ref<Cell>& in_msg, Ref<Cell>& transaction, Ref<CellSlice>& fwd_fee) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_msg_import_deferred_fin(cs, in_msg, transaction, fwd_fee) && cs.empty_ext();
}

bool InMsg::unpack(vm::CellSlice& cs, InMsg::Record_msg_import_deferred_tr& data) const {
  return cs.fetch_ulong(5) == 5
      && cs.fetch_ref_to(data.in_msg)
      && cs.fetch_ref_to(data.out_msg);
}

bool InMsg::unpack_msg_import_deferred_tr(vm::CellSlice& cs, Ref<Cell>& in_msg, Ref<Cell>& out_msg) const {
  return cs.fetch_ulong(5) == 5
      && cs.fetch_ref_to(in_msg)
      && cs.fetch_ref_to(out_msg);
}

bool InMsg::cell_unpack(Ref<vm::Cell> cell_ref, InMsg::Record_msg_import_deferred_tr& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool InMsg::cell_unpack_msg_import_deferred_tr(Ref<vm::Cell> cell_ref, Ref<Cell>& in_msg, Ref<Cell>& out_msg) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_msg_import_deferred_tr(cs, in_msg, out_msg) && cs.empty_ext();
}
...
bool InMsg::pack(vm::CellBuilder& cb, const InMsg::Record_msg_import_deferred_fin& data) const {
  return cb.store_long_bool(4, 5)
      && cb.store_ref_bool(data.in_msg)
      && cb.store_ref_bool(data.transaction)
      && t_Grams.store_from(cb, data.fwd_fee);
}

bool InMsg::pack_msg_import_deferred_fin(vm::CellBuilder& cb, Ref<Cell> in_msg, Ref<Cell> transaction, Ref<CellSlice> fwd_fee) const {
  return cb.store_long_bool(4, 5)
      && cb.store_ref_bool(in_msg)
      && cb.store_ref_bool(transaction)
      && t_Grams.store_from(cb, fwd_fee);
...
bool InMsg::cell_pack(Ref<vm::Cell>& cell_ref, const InMsg::Record_msg_import_deferred_fin& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool InMsg::cell_pack_msg_import_deferred_fin(Ref<vm::Cell>& cell_ref, Ref<Cell> in_msg, Ref<Cell> transaction, Ref<CellSlice> fwd_fee) const {
  vm::CellBuilder cb;
  return pack_msg_import_deferred_fin(cb, std::move(in_msg), std::move(transaction), std::move(fwd_fee)) && std::move(cb).finalize_to(cell_ref);
}

bool InMsg::pack(vm::CellBuilder& cb, const InMsg::Record_msg_import_deferred_tr& data) const {
  return cb.store_long_bool(5, 5)
      && cb.store_ref_bool(data.in_msg)
      && cb.store_ref_bool(data.out_msg);
}

bool InMsg::pack_msg_import_deferred_tr(vm::CellBuilder& cb, Ref<Cell> in_msg, Ref<Cell> out_msg) const {
  return cb.store_long_bool(5, 5)
      && cb.store_ref_bool(in_msg)
      && cb.store_ref_bool(out_msg);
}

bool InMsg::cell_pack(Ref<vm::Cell>& cell_ref, const InMsg::Record_msg_import_deferred_tr& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool InMsg::cell_pack_msg_import_deferred_tr(Ref<vm::Cell>& cell_ref, Ref<Cell> in_msg, Ref<Cell> out_msg) const {
  vm::CellBuilder cb;
  return pack_msg_import_deferred_tr(cb, std::move(in_msg), std::move(out_msg)) && std::move(cb).finalize_to(cell_ref);
}
...
bool InMsg::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  ...
  case msg_import_deferred_fin:
    return cs.advance(5)
        && pp.open("msg_import_deferred_fin")
        && pp.field("in_msg")
        && t_MsgEnvelope.print_ref(pp, cs.fetch_ref())
        && pp.field("transaction")
        && t_Transaction.print_ref(pp, cs.fetch_ref())
  ...
  case msg_import_deferred_tr:
    return cs.fetch_ulong(5) == 5
        && pp.open("msg_import_deferred_tr")
        && pp.field("in_msg")
        && t_MsgEnvelope.print_ref(pp, cs.fetch_ref())
        && pp.field("out_msg")
        && t_MsgEnvelope.print_ref(pp, cs.fetch_ref())
...
//
constexpr char OutMsg::cons_len[10];
constexpr unsigned char OutMsg::cons_tag[10];
...
int OutMsg::check_tag(const vm::CellSlice& cs) const {
  ...
  case msg_export_deq_imm:
    return cs.have(3) ? msg_export_deq_imm : -1;
  case msg_export_new_defer:
    return cs.have(5) ? msg_export_new_defer : -1;
  case msg_export_deferred_tr:
    return cs.prefetch_ulong(5) == 21 ? msg_export_deferred_tr : -1;
  }
  return -1;
}
...
bool OutMsg::unpack(vm::CellSlice& cs, OutMsg::Record_msg_export_new_defer& data) const {
  return cs.fetch_ulong(5) == 20
      && cs.fetch_ref_to(data.out_msg)
      && cs.fetch_ref_to(data.transaction);
}

bool OutMsg::unpack_msg_export_new_defer(vm::CellSlice& cs, Ref<Cell>& out_msg, Ref<Cell>& transaction) const {
  return cs.fetch_ulong(5) == 20
      && cs.fetch_ref_to(out_msg)
      && cs.fetch_ref_to(transaction);
}

bool OutMsg::cell_unpack(Ref<vm::Cell> cell_ref, OutMsg::Record_msg_export_new_defer& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool OutMsg::cell_unpack_msg_export_new_defer(Ref<vm::Cell> cell_ref, Ref<Cell>& out_msg, Ref<Cell>& transaction) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_msg_export_new_defer(cs, out_msg, transaction) && cs.empty_ext();
}

bool OutMsg::unpack(vm::CellSlice& cs, OutMsg::Record_msg_export_deferred_tr& data) const {
  return cs.fetch_ulong(5) == 21
      && cs.fetch_ref_to(data.out_msg)
      && cs.fetch_ref_to(data.imported);
}

bool OutMsg::unpack_msg_export_deferred_tr(vm::CellSlice& cs, Ref<Cell>& out_msg, Ref<Cell>& imported) const {
  return cs.fetch_ulong(5) == 21
      && cs.fetch_ref_to(out_msg)
      && cs.fetch_ref_to(imported);
}

bool OutMsg::cell_unpack(Ref<vm::Cell> cell_ref, OutMsg::Record_msg_export_deferred_tr& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool OutMsg::cell_unpack_msg_export_deferred_tr(Ref<vm::Cell> cell_ref, Ref<Cell>& out_msg, Ref<Cell>& imported) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_msg_export_deferred_tr(cs, out_msg, imported) && cs.empty_ext();
}
...
bool OutMsg::pack(vm::CellBuilder& cb, const OutMsg::Record_msg_export_new_defer& data) const {
  return cb.store_long_bool(20, 5)
      && cb.store_ref_bool(data.out_msg)
      && cb.store_ref_bool(data.transaction);
}

bool OutMsg::pack_msg_export_new_defer(vm::CellBuilder& cb, Ref<Cell> out_msg, Ref<Cell> transaction) const {
  return cb.store_long_bool(20, 5)
      && cb.store_ref_bool(out_msg)
      && cb.store_ref_bool(transaction);
}

bool OutMsg::cell_pack(Ref<vm::Cell>& cell_ref, const OutMsg::Record_msg_export_new_defer& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool OutMsg::cell_pack_msg_export_new_defer(Ref<vm::Cell>& cell_ref, Ref<Cell> out_msg, Ref<Cell> transaction) const {
  vm::CellBuilder cb;
  return pack_msg_export_new_defer(cb, std::move(out_msg), std::move(transaction)) && std::move(cb).finalize_to(cell_ref);
}

bool OutMsg::pack(vm::CellBuilder& cb, const OutMsg::Record_msg_export_deferred_tr& data) const {
  return cb.store_long_bool(21, 5)
      && cb.store_ref_bool(data.out_msg)
      && cb.store_ref_bool(data.imported);
}

bool OutMsg::pack_msg_export_deferred_tr(vm::CellBuilder& cb, Ref<Cell> out_msg, Ref<Cell> imported) const {
  return cb.store_long_bool(21, 5)
      && cb.store_ref_bool(out_msg)
      && cb.store_ref_bool(imported);
}

bool OutMsg::cell_pack(Ref<vm::Cell>& cell_ref, const OutMsg::Record_msg_export_deferred_tr& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool OutMsg::cell_pack_msg_export_deferred_tr(Ref<vm::Cell>& cell_ref, Ref<Cell> out_msg, Ref<Cell> imported) const {
  vm::CellBuilder cb;
  return pack_msg_export_deferred_tr(cb, std::move(out_msg), std::move(imported)) && std::move(cb).finalize_to(cell_ref);
}
...
bool OutMsg::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  ...
  case msg_export_deferred_tr:
    return cs.fetch_ulong(5) == 21
        && pp.open("msg_export_deferred_tr")
        && pp.field("out_msg")
        && t_MsgEnvelope.print_ref(pp, cs.fetch_ref())
        && pp.field("imported")
        && t_InMsg.print_ref(pp, cs.fetch_ref())
...
//
// code for type `AccountDispatchQueue`
//

int AccountDispatchQueue::check_tag(const vm::CellSlice& cs) const {
  return cons1;
}

bool AccountDispatchQueue::skip(vm::CellSlice& cs) const {
  return t_HashmapE_64_EnqueuedMsg.skip(cs)
      && cs.advance(48);
}

bool AccountDispatchQueue::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return t_HashmapE_64_EnqueuedMsg.validate_skip(ops, cs, weak)
      && cs.advance(48);
}

bool AccountDispatchQueue::unpack(vm::CellSlice& cs, AccountDispatchQueue::Record& data) const {
  return t_HashmapE_64_EnqueuedMsg.fetch_to(cs, data.messages)
      && cs.fetch_uint_to(48, data.count);
}

bool AccountDispatchQueue::unpack_cons1(vm::CellSlice& cs, Ref<CellSlice>& messages, long long& count) const {
  return t_HashmapE_64_EnqueuedMsg.fetch_to(cs, messages)
      && cs.fetch_uint_to(48, count);
}

bool AccountDispatchQueue::cell_unpack(Ref<vm::Cell> cell_ref, AccountDispatchQueue::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool AccountDispatchQueue::cell_unpack_cons1(Ref<vm::Cell> cell_ref, Ref<CellSlice>& messages, long long& count) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons1(cs, messages, count) && cs.empty_ext();
}

bool AccountDispatchQueue::pack(vm::CellBuilder& cb, const AccountDispatchQueue::Record& data) const {
  return t_HashmapE_64_EnqueuedMsg.store_from(cb, data.messages)
      && cb.store_ulong_rchk_bool(data.count, 48);
}

bool AccountDispatchQueue::pack_cons1(vm::CellBuilder& cb, Ref<CellSlice> messages, long long count) const {
  return t_HashmapE_64_EnqueuedMsg.store_from(cb, messages)
      && cb.store_ulong_rchk_bool(count, 48);
}

bool AccountDispatchQueue::cell_pack(Ref<vm::Cell>& cell_ref, const AccountDispatchQueue::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool AccountDispatchQueue::cell_pack_cons1(Ref<vm::Cell>& cell_ref, Ref<CellSlice> messages, long long count) const {
  vm::CellBuilder cb;
  return pack_cons1(cb, std::move(messages), count) && std::move(cb).finalize_to(cell_ref);
}

bool AccountDispatchQueue::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return pp.open()
      && pp.field("messages")
      && t_HashmapE_64_EnqueuedMsg.print_skip(pp, cs)
      && pp.fetch_uint_field(cs, 48, "count")
      && pp.close();
}

const AccountDispatchQueue t_AccountDispatchQueue;

//
// code for type `DispatchQueue`
//

int DispatchQueue::check_tag(const vm::CellSlice& cs) const {
  return cons1;
}

bool DispatchQueue::skip(vm::CellSlice& cs) const {
  return t_HashmapAugE_256_AccountDispatchQueue_uint64.skip(cs);
}

bool DispatchQueue::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return t_HashmapAugE_256_AccountDispatchQueue_uint64.validate_skip(ops, cs, weak);
}

bool DispatchQueue::unpack(vm::CellSlice& cs, DispatchQueue::Record& data) const {
  return t_HashmapAugE_256_AccountDispatchQueue_uint64.fetch_to(cs, data.x);
}

bool DispatchQueue::unpack_cons1(vm::CellSlice& cs, Ref<CellSlice>& x) const {
  return t_HashmapAugE_256_AccountDispatchQueue_uint64.fetch_to(cs, x);
}

bool DispatchQueue::cell_unpack(Ref<vm::Cell> cell_ref, DispatchQueue::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool DispatchQueue::cell_unpack_cons1(Ref<vm::Cell> cell_ref, Ref<CellSlice>& x) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons1(cs, x) && cs.empty_ext();
}

bool DispatchQueue::pack(vm::CellBuilder& cb, const DispatchQueue::Record& data) const {
  return t_HashmapAugE_256_AccountDispatchQueue_uint64.store_from(cb, data.x);
}

bool DispatchQueue::pack_cons1(vm::CellBuilder& cb, Ref<CellSlice> x) const {
  return t_HashmapAugE_256_AccountDispatchQueue_uint64.store_from(cb, x);
}

bool DispatchQueue::cell_pack(Ref<vm::Cell>& cell_ref, const DispatchQueue::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool DispatchQueue::cell_pack_cons1(Ref<vm::Cell>& cell_ref, Ref<CellSlice> x) const {
  vm::CellBuilder cb;
  return pack_cons1(cb, std::move(x)) && std::move(cb).finalize_to(cell_ref);
}

bool DispatchQueue::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return pp.open()
      && pp.field()
      && t_HashmapAugE_256_AccountDispatchQueue_uint64.print_skip(pp, cs)
      && pp.close();
}

const DispatchQueue t_DispatchQueue;

//
// code for type `OutMsgQueueExtra`
//

int OutMsgQueueExtra::check_tag(const vm::CellSlice& cs) const {
  return cs.prefetch_ulong(4) == 0 ? out_msg_queue_extra : -1;
}

bool OutMsgQueueExtra::skip(vm::CellSlice& cs) const {
  return cs.advance(4)
      && t_DispatchQueue.skip(cs)
      && t_Maybe_uint48.skip(cs);
}

bool OutMsgQueueExtra::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return cs.fetch_ulong(4) == 0
      && t_DispatchQueue.validate_skip(ops, cs, weak)
      && t_Maybe_uint48.validate_skip(ops, cs, weak);
}

bool OutMsgQueueExtra::unpack(vm::CellSlice& cs, OutMsgQueueExtra::Record& data) const {
  return cs.fetch_ulong(4) == 0
      && t_DispatchQueue.fetch_to(cs, data.dispatch_queue)
      && t_Maybe_uint48.fetch_to(cs, data.out_queue_size);
}

bool OutMsgQueueExtra::unpack_out_msg_queue_extra(vm::CellSlice& cs, Ref<CellSlice>& dispatch_queue, Ref<CellSlice>& out_queue_size) const {
  return cs.fetch_ulong(4) == 0
      && t_DispatchQueue.fetch_to(cs, dispatch_queue)
      && t_Maybe_uint48.fetch_to(cs, out_queue_size);
}

bool OutMsgQueueExtra::cell_unpack(Ref<vm::Cell> cell_ref, OutMsgQueueExtra::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool OutMsgQueueExtra::cell_unpack_out_msg_queue_extra(Ref<vm::Cell> cell_ref, Ref<CellSlice>& dispatch_queue, Ref<CellSlice>& out_queue_size) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_out_msg_queue_extra(cs, dispatch_queue, out_queue_size) && cs.empty_ext();
}

bool OutMsgQueueExtra::pack(vm::CellBuilder& cb, const OutMsgQueueExtra::Record& data) const {
  return cb.store_long_bool(0, 4)
      && t_DispatchQueue.store_from(cb, data.dispatch_queue)
      && t_Maybe_uint48.store_from(cb, data.out_queue_size);
}

bool OutMsgQueueExtra::pack_out_msg_queue_extra(vm::CellBuilder& cb, Ref<CellSlice> dispatch_queue, Ref<CellSlice> out_queue_size) const {
  return cb.store_long_bool(0, 4)
      && t_DispatchQueue.store_from(cb, dispatch_queue)
      && t_Maybe_uint48.store_from(cb, out_queue_size);
}

bool OutMsgQueueExtra::cell_pack(Ref<vm::Cell>& cell_ref, const OutMsgQueueExtra::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool OutMsgQueueExtra::cell_pack_out_msg_queue_extra(Ref<vm::Cell>& cell_ref, Ref<CellSlice> dispatch_queue, Ref<CellSlice> out_queue_size) const {
  vm::CellBuilder cb;
  return pack_out_msg_queue_extra(cb, std::move(dispatch_queue), std::move(out_queue_size)) && std::move(cb).finalize_to(cell_ref);
}

bool OutMsgQueueExtra::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return cs.fetch_ulong(4) == 0
      && pp.open("out_msg_queue_extra")
      && pp.field("dispatch_queue")
      && t_DispatchQueue.print_skip(pp, cs)
      && pp.field("out_queue_size")
      && t_Maybe_uint48.print_skip(pp, cs)
      && pp.close();
}

const OutMsgQueueExtra t_OutMsgQueueExtra;
...
bool OutMsgQueueInfo::skip(vm::CellSlice& cs) const {
  return t_OutMsgQueue.skip(cs)
      ...
      && t_Maybe_OutMsgQueueExtra.skip(cs);
}
...
bool OutMsgQueueInfo::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return t_OutMsgQueue.validate_skip(ops, cs, weak)
      ...
      && t_Maybe_OutMsgQueueExtra.validate_skip(ops, cs, weak);
}
...
bool OutMsgQueueInfo::unpack(vm::CellSlice& cs, OutMsgQueueInfo::Record& data) const {
  return t_OutMsgQueue.fetch_to(cs, data.out_queue)
      ...
      && t_Maybe_OutMsgQueueExtra.fetch_to(cs, data.extra);
}

bool OutMsgQueueInfo::unpack_cons1(vm::CellSlice& cs, Ref<CellSlice>& out_queue, Ref<CellSlice>& proc_info, Ref<CellSlice>& extra) const {
  return t_OutMsgQueue.fetch_to(cs, out_queue)
      && t_ProcessedInfo.fetch_to(cs, proc_info)
      && t_Maybe_OutMsgQueueExtra.fetch_to(cs, extra);
}
...
bool OutMsgQueueInfo::cell_unpack_cons1(Ref<vm::Cell> cell_ref, Ref<CellSlice>& out_queue, Ref<CellSlice>& proc_info, Ref<CellSlice>& extra) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons1(cs, out_queue, proc_info, extra) && cs.empty_ext();
}
...
bool OutMsgQueueInfo::pack(vm::CellBuilder& cb, const OutMsgQueueInfo::Record& data) const {
  return t_OutMsgQueue.store_from(cb, data.out_queue)
      ...
      && t_Maybe_OutMsgQueueExtra.store_from(cb, data.extra);
}

bool OutMsgQueueInfo::pack_cons1(vm::CellBuilder& cb, Ref<CellSlice> out_queue, Ref<CellSlice> proc_info, Ref<CellSlice> extra) const {
  return t_OutMsgQueue.store_from(cb, out_queue)
      && t_ProcessedInfo.store_from(cb, proc_info)
      && t_Maybe_OutMsgQueueExtra.store_from(cb, extra);
}
...
bool OutMsgQueueInfo::cell_pack_cons1(Ref<vm::Cell>& cell_ref, Ref<CellSlice> out_queue, Ref<CellSlice> proc_info, Ref<CellSlice> extra) const {
  vm::CellBuilder cb;
  return pack_cons1(cb, std::move(out_queue), std::move(proc_info), std::move(extra)) && std::move(cb).finalize_to(cell_ref);
}
...
bool OutMsgQueueInfo::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return pp.open()
      ...
      && pp.field("extra")
      && t_Maybe_OutMsgQueueExtra.print_skip(pp, cs)
      && pp.close();
}
...
//
// code for type `BlockRelaxed`
//
constexpr unsigned BlockRelaxed::cons_tag[1];

int BlockRelaxed::check_tag(const vm::CellSlice& cs) const {
  return cs.prefetch_ulong(32) == 0x11ef55aa ? block_relaxed : -1;
}

bool BlockRelaxed::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return cs.fetch_ulong(32) == 0x11ef55aa
      && cs.advance(32)
      && t_BlockInfo.validate_skip_ref(ops, cs, weak)
      && t_ValueFlow.validate_skip_ref(ops, cs, weak)
...
bool BlockRelaxed::unpack(vm::CellSlice& cs, BlockRelaxed::Record& data) const {
  return cs.fetch_ulong(32) == 0x11ef55aa
      && cs.fetch_int_to(32, data.global_id)
      && cs.fetch_ref_to(data.info)
      && cs.fetch_ref_to(data.value_flow)
...
bool BlockRelaxed::cell_unpack(Ref<vm::Cell> cell_ref, BlockRelaxed::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool BlockRelaxed::pack(vm::CellBuilder& cb, const BlockRelaxed::Record& data) const {
  return cb.store_long_bool(0x11ef55aa, 32)
      && cb.store_long_rchk_bool(data.global_id, 32)
      && cb.store_ref_bool(data.info)
      && cb.store_ref_bool(data.value_flow)
...
bool BlockRelaxed::cell_pack(Ref<vm::Cell>& cell_ref, const BlockRelaxed::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool BlockRelaxed::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return cs.fetch_ulong(32) == 0x11ef55aa
      && pp.open("block_relaxed")
      && pp.fetch_int_field(cs, 32, "global_id")
      && pp.field("info")
      && t_BlockInfo.print_ref(pp, cs.fetch_ref())
      && pp.field("value_flow")
...
const BlockRelaxed t_BlockRelaxed;
...
//
// code for auxiliary type `TYPE_1658`
//

int TYPE_1658::check_tag(const vm::CellSlice& cs) const {
  return cons1;
}

bool TYPE_1658::skip(vm::CellSlice& cs) const {
...
bool TYPE_1658::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
...
bool TYPE_1658::unpack(vm::CellSlice& cs, TYPE_1658::Record& data) const {
...
bool TYPE_1658::cell_unpack(Ref<vm::Cell> cell_ref, TYPE_1658::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool TYPE_1658::pack(vm::CellBuilder& cb, const TYPE_1658::Record& data) const {
...
bool TYPE_1658::cell_pack(Ref<vm::Cell>& cell_ref, const TYPE_1658::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool TYPE_1658::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return pp.open()
...
const TYPE_1658 t_TYPE_1658;

//
// code for auxiliary type `TYPE_1659`
//

int TYPE_1659::check_tag(const vm::CellSlice& cs) const {
  return cons1;
}

bool TYPE_1659::skip(vm::CellSlice& cs) const {
  return t_CurrencyCollection.skip(cs)
      && t_CurrencyCollection.skip(cs)
      && t_CurrencyCollection.skip(cs)
      && t_CurrencyCollection.skip(cs);
...
bool TYPE_1659::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return t_CurrencyCollection.validate_skip(ops, cs, weak)
      && t_CurrencyCollection.validate_skip(ops, cs, weak)
      && t_CurrencyCollection.validate_skip(ops, cs, weak)
      && t_CurrencyCollection.validate_skip(ops, cs, weak);
...
bool TYPE_1659::unpack(vm::CellSlice& cs, TYPE_1659::Record& data) const {
...
bool TYPE_1659::cell_unpack(Ref<vm::Cell> cell_ref, TYPE_1659::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool TYPE_1659::pack(vm::CellBuilder& cb, const TYPE_1659::Record& data) const {
...
bool TYPE_1659::cell_pack(Ref<vm::Cell>& cell_ref, const TYPE_1659::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool TYPE_1659::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return pp.open()
...
bool ValueFlow::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  ...
  case value_flow:
    return cs.fetch_ulong(32) == 0xb8e48dfbU
        && t_TYPE_1658.validate_skip_ref(ops, cs, weak)
        && t_CurrencyCollection.validate_skip(ops, cs, weak)
        && t_TYPE_1659.validate_skip_ref(ops, cs, weak);
  case value_flow_v2:
...
bool ValueFlow::unpack(vm::CellSlice& cs, ValueFlow::Record_value_flow& data) const {
  return cs.fetch_ulong(32) == 0xb8e48dfbU
      && t_TYPE_1658.cell_unpack(cs.fetch_ref(), data.r1)
      && t_CurrencyCollection.fetch_to(cs, data.fees_collected)
      && t_TYPE_1659.cell_unpack(cs.fetch_ref(), data.r2);
}
...
bool ValueFlow::pack(vm::CellBuilder& cb, const ValueFlow::Record_value_flow& data) const {
  ...
  return cb.store_long_bool(0xb8e48dfbU, 32)
      && t_TYPE_1658.cell_pack(tmp_cell, data.r1)
      && cb.store_ref_bool(std::move(tmp_cell))
      && t_CurrencyCollection.store_from(cb, data.fees_collected)
      && t_TYPE_1659.cell_pack(tmp_cell, data.r2)
      && cb.store_ref_bool(std::move(tmp_cell));
}
...
bool ValueFlow::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  ...
  case value_flow:
    return cs.fetch_ulong(32) == 0xb8e48dfbU
        && pp.open("value_flow")
        && pp.field()
        && t_TYPE_1658.print_ref(pp, cs.fetch_ref())
        && pp.field("fees_collected")
        && t_CurrencyCollection.print_skip(pp, cs)
        && pp.field()
        && t_TYPE_1659.print_ref(pp, cs.fetch_ref())
        && pp.close();
  case value_flow_v2:
    return cs.fetch_ulong(32) == 0x3ebf98b7
...
bool WorkchainDescr::skip(vm::CellSlice& cs) const {
  switch (get_tag(cs)) {
  case workchain: {
    int monitor_min_split, min_split, basic, flags;
    return cs.advance(40)
        && cs.fetch_uint_to(8, monitor_min_split)
        && cs.fetch_uint_to(8, min_split)
        && monitor_min_split <= min_split
        && cs.advance(8)
...
bool WorkchainDescr::unpack(vm::CellSlice& cs, WorkchainDescr::Record_workchain& data) const {
  return cs.fetch_ulong(8) == 0xa6
      ...
      && cs.fetch_uint_to(8, data.monitor_min_split)
      && cs.fetch_uint_to(8, data.min_split)
      && cs.fetch_uint_to(8, data.max_split)
      && data.monitor_min_split <= data.min_split
...
bool WorkchainDescr::pack(vm::CellBuilder& cb, const WorkchainDescr::Record_workchain& data) const {
  return cb.store_long_bool(0xa6, 8)
      ...
      && cb.store_ulong_rchk_bool(data.monitor_min_split, 8)
...
bool WorkchainDescr::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  switch (get_tag(cs)) {
  case workchain: {
    int monitor_min_split, min_split, max_split, basic, flags;
    return cs.fetch_ulong(8) == 0xa6
        && pp.open("workchain")
        && pp.fetch_uint_field(cs, 32, "enabled_since")
        && cs.fetch_uint_to(8, monitor_min_split)
        && pp.field_int(monitor_min_split, "monitor_min_split")
        && cs.fetch_uint_to(8, min_split)
...
//
// code for type `ImportedMsgQueueLimits`
//
constexpr unsigned char ImportedMsgQueueLimits::cons_tag[1];

int ImportedMsgQueueLimits::check_tag(const vm::CellSlice& cs) const {
  return cs.prefetch_ulong(8) == 0xd3 ? imported_msg_queue_limits : -1;
}

bool ImportedMsgQueueLimits::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return cs.fetch_ulong(8) == 0xd3
      && cs.advance(64);
}

bool ImportedMsgQueueLimits::unpack(vm::CellSlice& cs, ImportedMsgQueueLimits::Record& data) const {
  return cs.fetch_ulong(8) == 0xd3
      && cs.fetch_uint_to(32, data.max_bytes)
      && cs.fetch_uint_to(32, data.max_msgs);
}

bool ImportedMsgQueueLimits::unpack_imported_msg_queue_limits(vm::CellSlice& cs, int& max_bytes, int& max_msgs) const {
  return cs.fetch_ulong(8) == 0xd3
      && cs.fetch_uint_to(32, max_bytes)
      && cs.fetch_uint_to(32, max_msgs);
}

bool ImportedMsgQueueLimits::cell_unpack(Ref<vm::Cell> cell_ref, ImportedMsgQueueLimits::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ImportedMsgQueueLimits::cell_unpack_imported_msg_queue_limits(Ref<vm::Cell> cell_ref, int& max_bytes, int& max_msgs) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_imported_msg_queue_limits(cs, max_bytes, max_msgs) && cs.empty_ext();
}

bool ImportedMsgQueueLimits::pack(vm::CellBuilder& cb, const ImportedMsgQueueLimits::Record& data) const {
  return cb.store_long_bool(0xd3, 8)
      && cb.store_ulong_rchk_bool(data.max_bytes, 32)
      && cb.store_ulong_rchk_bool(data.max_msgs, 32);
}

bool ImportedMsgQueueLimits::pack_imported_msg_queue_limits(vm::CellBuilder& cb, int max_bytes, int max_msgs) const {
  return cb.store_long_bool(0xd3, 8)
      && cb.store_ulong_rchk_bool(max_bytes, 32)
      && cb.store_ulong_rchk_bool(max_msgs, 32);
}

bool ImportedMsgQueueLimits::cell_pack(Ref<vm::Cell>& cell_ref, const ImportedMsgQueueLimits::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ImportedMsgQueueLimits::cell_pack_imported_msg_queue_limits(Ref<vm::Cell>& cell_ref, int max_bytes, int max_msgs) const {
  vm::CellBuilder cb;
  return pack_imported_msg_queue_limits(cb, max_bytes, max_msgs) && std::move(cb).finalize_to(cell_ref);
}

bool ImportedMsgQueueLimits::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  int max_bytes, max_msgs;
  return cs.fetch_ulong(8) == 0xd3
      && pp.open("imported_msg_queue_limits")
      && cs.fetch_uint_to(32, max_bytes)
      && pp.field_int(max_bytes, "max_bytes")
      && cs.fetch_uint_to(32, max_msgs)
      && pp.field_int(max_msgs, "max_msgs")
      && pp.close();
}

const ImportedMsgQueueLimits t_ImportedMsgQueueLimits;

//
// code for type `BlockLimits`
//
constexpr unsigned char BlockLimits::cons_tag[2];

int BlockLimits::get_tag(const vm::CellSlice& cs) const {
  switch (cs.bselect(6, 0x1800000)) {
  case 0:
    return cs.bit_at(6) ? block_limits_v2 : block_limits;
  default:
    return -1;
  }
}
...
int BlockLimits::check_tag(const vm::CellSlice& cs) const {
  ...
  case block_limits_v2:
    return cs.prefetch_ulong(8) == 0x5e ? block_limits_v2 : -1;
  }
  return -1;
}

bool BlockLimits::skip(vm::CellSlice& cs) const {
  switch (get_tag(cs)) {
  case block_limits:
    return cs.advance(320);
  case block_limits_v2:
    return cs.advance(496);
  }
  return false;
}
...
bool BlockLimits::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  ...
  case block_limits:
    return cs.fetch_ulong(8) == 0x5d
        ...
        && t_ParamLimits.validate_skip(ops, cs, weak);
  case block_limits_v2:
    return cs.fetch_ulong(8) == 0x5e
        && t_ParamLimits.validate_skip(ops, cs, weak)
        && t_ParamLimits.validate_skip(ops, cs, weak)
        && t_ParamLimits.validate_skip(ops, cs, weak)
        && t_ParamLimits.validate_skip(ops, cs, weak)
        && t_ImportedMsgQueueLimits.validate_skip(ops, cs, weak);
  }
  return false;
}

bool BlockLimits::unpack(vm::CellSlice& cs, BlockLimits::Record_block_limits& data) const {
  return cs.fetch_ulong(8) == 0x5d
...
bool BlockLimits::cell_unpack(Ref<vm::Cell> cell_ref, BlockLimits::Record_block_limits& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}
...
bool BlockLimits::unpack(vm::CellSlice& cs, BlockLimits::Record_block_limits_v2& data) const {
  return cs.fetch_ulong(8) == 0x5e
      && cs.fetch_subslice_to(104, data.bytes)
      && cs.fetch_subslice_to(104, data.gas)
      && cs.fetch_subslice_to(104, data.lt_delta)
      && cs.fetch_subslice_to(104, data.collated_data)
      && cs.fetch_subslice_to(72, data.imported_msg_queue);
}

bool BlockLimits::cell_unpack(Ref<vm::Cell> cell_ref, BlockLimits::Record_block_limits_v2& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool BlockLimits::pack(vm::CellBuilder& cb, const BlockLimits::Record_block_limits& data) const {
...
bool BlockLimits::cell_pack(Ref<vm::Cell>& cell_ref, const BlockLimits::Record_block_limits& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}
...
bool BlockLimits::pack(vm::CellBuilder& cb, const BlockLimits::Record_block_limits_v2& data) const {
  return cb.store_long_bool(0x5e, 8)
      && cb.append_cellslice_chk(data.bytes, 104)
      && cb.append_cellslice_chk(data.gas, 104)
      && cb.append_cellslice_chk(data.lt_delta, 104)
      && cb.append_cellslice_chk(data.collated_data, 104)
      && cb.append_cellslice_chk(data.imported_msg_queue, 72);
}

bool BlockLimits::cell_pack(Ref<vm::Cell>& cell_ref, const BlockLimits::Record_block_limits_v2& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}
...
bool BlockLimits::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  ...
  case block_limits_v2:
    return cs.fetch_ulong(8) == 0x5e
        ...
        && pp.field("lt_delta")
        && t_ParamLimits.print_skip(pp, cs)
        && pp.field("collated_data")
        && t_ParamLimits.print_skip(pp, cs)
        && pp.field("imported_msg_queue")
        && t_ImportedMsgQueueLimits.print_skip(pp, cs)
        && pp.close();
  }
  return pp.fail("unknown constructor for BlockLimits");
}
...
bool SizeLimitsConfig::unpack(vm::CellSlice& cs, SizeLimitsConfig::Record_size_limits_config_v2& data) const {
  return cs.fetch_ulong(8) == 2
      ...
      && cs.fetch_uint_to(32, data.defer_out_queue_size_limit);
}
...
bool SizeLimitsConfig::pack(vm::CellBuilder& cb, const SizeLimitsConfig::Record_size_limits_config_v2& data) const {
  return cb.store_long_bool(2, 8)
      ...
      && cb.store_ulong_rchk_bool(data.defer_out_queue_size_limit, 32);
}
...
bool SizeLimitsConfig::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  ...
  case size_limits_config_v2:
    return cs.fetch_ulong(8) == 2
        ...
        && pp.fetch_uint_field(cs, 32, "defer_out_queue_size_limit")
        && pp.close();
  }
...
//
// code for type `PrecompiledSmc`
//
constexpr unsigned char PrecompiledSmc::cons_tag[1];

int PrecompiledSmc::check_tag(const vm::CellSlice& cs) const {
  return cs.prefetch_ulong(8) == 0xb0 ? precompiled_smc : -1;
}

bool PrecompiledSmc::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return cs.fetch_ulong(8) == 0xb0
      && cs.advance(64);
}

bool PrecompiledSmc::unpack(vm::CellSlice& cs, PrecompiledSmc::Record& data) const {
  return cs.fetch_ulong(8) == 0xb0
      && cs.fetch_uint_to(64, data.gas_usage);
}

bool PrecompiledSmc::unpack_precompiled_smc(vm::CellSlice& cs, unsigned long long& gas_usage) const {
  return cs.fetch_ulong(8) == 0xb0
      && cs.fetch_uint_to(64, gas_usage);
}

bool PrecompiledSmc::cell_unpack(Ref<vm::Cell> cell_ref, PrecompiledSmc::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool PrecompiledSmc::cell_unpack_precompiled_smc(Ref<vm::Cell> cell_ref, unsigned long long& gas_usage) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_precompiled_smc(cs, gas_usage) && cs.empty_ext();
}

bool PrecompiledSmc::pack(vm::CellBuilder& cb, const PrecompiledSmc::Record& data) const {
  return cb.store_long_bool(0xb0, 8)
      && cb.store_ulong_rchk_bool(data.gas_usage, 64);
}

bool PrecompiledSmc::pack_precompiled_smc(vm::CellBuilder& cb, unsigned long long gas_usage) const {
  return cb.store_long_bool(0xb0, 8)
      && cb.store_ulong_rchk_bool(gas_usage, 64);
}

bool PrecompiledSmc::cell_pack(Ref<vm::Cell>& cell_ref, const PrecompiledSmc::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool PrecompiledSmc::cell_pack_precompiled_smc(Ref<vm::Cell>& cell_ref, unsigned long long gas_usage) const {
  vm::CellBuilder cb;
  return pack_precompiled_smc(cb, gas_usage) && std::move(cb).finalize_to(cell_ref);
}

bool PrecompiledSmc::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return cs.fetch_ulong(8) == 0xb0
      && pp.open("precompiled_smc")
      && pp.fetch_uint_field(cs, 64, "gas_usage")
      && pp.close();
}

const PrecompiledSmc t_PrecompiledSmc;

//
// code for type `PrecompiledContractsConfig`
//
constexpr unsigned char PrecompiledContractsConfig::cons_tag[1];

int PrecompiledContractsConfig::check_tag(const vm::CellSlice& cs) const {
  return cs.prefetch_ulong(8) == 0xc0 ? precompiled_contracts_config : -1;
}

bool PrecompiledContractsConfig::skip(vm::CellSlice& cs) const {
  return cs.advance(8)
      && t_HashmapE_256_PrecompiledSmc.skip(cs);
}

bool PrecompiledContractsConfig::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return cs.fetch_ulong(8) == 0xc0
      && t_HashmapE_256_PrecompiledSmc.validate_skip(ops, cs, weak);
}

bool PrecompiledContractsConfig::unpack(vm::CellSlice& cs, PrecompiledContractsConfig::Record& data) const {
  return cs.fetch_ulong(8) == 0xc0
      && t_HashmapE_256_PrecompiledSmc.fetch_to(cs, data.list);
}

bool PrecompiledContractsConfig::unpack_precompiled_contracts_config(vm::CellSlice& cs, Ref<CellSlice>& list) const {
  return cs.fetch_ulong(8) == 0xc0
      && t_HashmapE_256_PrecompiledSmc.fetch_to(cs, list);
}

bool PrecompiledContractsConfig::cell_unpack(Ref<vm::Cell> cell_ref, PrecompiledContractsConfig::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool PrecompiledContractsConfig::cell_unpack_precompiled_contracts_config(Ref<vm::Cell> cell_ref, Ref<CellSlice>& list) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_precompiled_contracts_config(cs, list) && cs.empty_ext();
}

bool PrecompiledContractsConfig::pack(vm::CellBuilder& cb, const PrecompiledContractsConfig::Record& data) const {
  return cb.store_long_bool(0xc0, 8)
      && t_HashmapE_256_PrecompiledSmc.store_from(cb, data.list);
}

bool PrecompiledContractsConfig::pack_precompiled_contracts_config(vm::CellBuilder& cb, Ref<CellSlice> list) const {
  return cb.store_long_bool(0xc0, 8)
      && t_HashmapE_256_PrecompiledSmc.store_from(cb, list);
}

bool PrecompiledContractsConfig::cell_pack(Ref<vm::Cell>& cell_ref, const PrecompiledContractsConfig::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool PrecompiledContractsConfig::cell_pack_precompiled_contracts_config(Ref<vm::Cell>& cell_ref, Ref<CellSlice> list) const {
  vm::CellBuilder cb;
  return pack_precompiled_contracts_config(cb, std::move(list)) && std::move(cb).finalize_to(cell_ref);
}

bool PrecompiledContractsConfig::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return cs.fetch_ulong(8) == 0xc0
      && pp.open("precompiled_contracts_config")
      && pp.field("list")
      && t_HashmapE_256_PrecompiledSmc.print_skip(pp, cs)
      && pp.close();
}

const PrecompiledContractsConfig t_PrecompiledContractsConfig;
...
bool ConfigParam::skip(vm::CellSlice& cs) const {
  ...
  case cons44:
    return t_SuspendedAddressList.skip(cs)
        && m_ == 44;
  case cons45:
    return t_PrecompiledContractsConfig.skip(cs)
        && m_ == 45;
  case cons71:
...
bool ConfigParam::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  ...
  case cons44:
    return t_SuspendedAddressList.validate_skip(ops, cs, weak)
        && m_ == 44;
  case cons45:
    return t_PrecompiledContractsConfig.validate_skip(ops, cs, weak)
        && m_ == 45;
  case cons71:
...
bool ConfigParam::unpack(vm::CellSlice& cs, ConfigParam::Record_cons45& data) const {
  return t_PrecompiledContractsConfig.fetch_to(cs, data.x)
      && m_ == 45;
}

bool ConfigParam::unpack_cons45(vm::CellSlice& cs, Ref<CellSlice>& x) const {
  return t_PrecompiledContractsConfig.fetch_to(cs, x)
      && m_ == 45;
}

bool ConfigParam::cell_unpack(Ref<vm::Cell> cell_ref, ConfigParam::Record_cons45& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ConfigParam::cell_unpack_cons45(Ref<vm::Cell> cell_ref, Ref<CellSlice>& x) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_cons45(cs, x) && cs.empty_ext();
}
...
bool ConfigParam::pack(vm::CellBuilder& cb, const ConfigParam::Record_cons45& data) const {
  return t_PrecompiledContractsConfig.store_from(cb, data.x)
      && m_ == 45;
}

bool ConfigParam::pack_cons45(vm::CellBuilder& cb, Ref<CellSlice> x) const {
  return t_PrecompiledContractsConfig.store_from(cb, x)
      && m_ == 45;
}

bool ConfigParam::cell_pack(Ref<vm::Cell>& cell_ref, const ConfigParam::Record_cons45& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ConfigParam::cell_pack_cons45(Ref<vm::Cell>& cell_ref, Ref<CellSlice> x) const {
  vm::CellBuilder cb;
  return pack_cons45(cb, std::move(x)) && std::move(cb).finalize_to(cell_ref);
}
...
bool ConfigParam::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  ...
  case cons45:
    return pp.open()
        && pp.field()
        && t_PrecompiledContractsConfig.print_skip(pp, cs)
        && m_ == 45
        && pp.close();
  case cons71:
    return pp.open()
...
//
// code for type `ExtraCollatedData`
//
constexpr unsigned ExtraCollatedData::cons_tag[1];

int ExtraCollatedData::check_tag(const vm::CellSlice& cs) const {
  return cs.prefetch_ulong(32) == 0xea59be4cU ? extra_collated_data : -1;
}

bool ExtraCollatedData::skip(vm::CellSlice& cs) const {
  return cs.advance(34)
      && t_ProcessedInfo.skip(cs);
}

bool ExtraCollatedData::validate_skip(int* ops, vm::CellSlice& cs, bool weak) const {
  return cs.fetch_ulong(32) == 0xea59be4cU
      && cs.advance(2)
      && t_ProcessedInfo.validate_skip(ops, cs, weak);
}

bool ExtraCollatedData::unpack(vm::CellSlice& cs, ExtraCollatedData::Record& data) const {
  return cs.fetch_ulong(32) == 0xea59be4cU
      && cs.fetch_bool_to(data.underload)
      && cs.fetch_bool_to(data.overload)
      && t_ProcessedInfo.fetch_to(cs, data.proc_info);
}

bool ExtraCollatedData::unpack_extra_collated_data(vm::CellSlice& cs, bool& underload, bool& overload, Ref<CellSlice>& proc_info) const {
  return cs.fetch_ulong(32) == 0xea59be4cU
      && cs.fetch_bool_to(underload)
      && cs.fetch_bool_to(overload)
      && t_ProcessedInfo.fetch_to(cs, proc_info);
}

bool ExtraCollatedData::cell_unpack(Ref<vm::Cell> cell_ref, ExtraCollatedData::Record& data) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack(cs, data) && cs.empty_ext();
}

bool ExtraCollatedData::cell_unpack_extra_collated_data(Ref<vm::Cell> cell_ref, bool& underload, bool& overload, Ref<CellSlice>& proc_info) const {
  if (cell_ref.is_null()) { return false; }
  auto cs = load_cell_slice(std::move(cell_ref));
  return unpack_extra_collated_data(cs, underload, overload, proc_info) && cs.empty_ext();
}

bool ExtraCollatedData::pack(vm::CellBuilder& cb, const ExtraCollatedData::Record& data) const {
  return cb.store_long_bool(0xea59be4cU, 32)
      && cb.store_ulong_rchk_bool(data.underload, 1)
      && cb.store_ulong_rchk_bool(data.overload, 1)
      && t_ProcessedInfo.store_from(cb, data.proc_info);
}

bool ExtraCollatedData::pack_extra_collated_data(vm::CellBuilder& cb, bool underload, bool overload, Ref<CellSlice> proc_info) const {
  return cb.store_long_bool(0xea59be4cU, 32)
      && cb.store_ulong_rchk_bool(underload, 1)
      && cb.store_ulong_rchk_bool(overload, 1)
      && t_ProcessedInfo.store_from(cb, proc_info);
}

bool ExtraCollatedData::cell_pack(Ref<vm::Cell>& cell_ref, const ExtraCollatedData::Record& data) const {
  vm::CellBuilder cb;
  return pack(cb, data) && std::move(cb).finalize_to(cell_ref);
}

bool ExtraCollatedData::cell_pack_extra_collated_data(Ref<vm::Cell>& cell_ref, bool underload, bool overload, Ref<CellSlice> proc_info) const {
  vm::CellBuilder cb;
  return pack_extra_collated_data(cb, underload, overload, std::move(proc_info)) && std::move(cb).finalize_to(cell_ref);
}

bool ExtraCollatedData::print_skip(PrettyPrinter& pp, vm::CellSlice& cs) const {
  return cs.fetch_ulong(32) == 0xea59be4cU
      && pp.open("extra_collated_data")
      && pp.fetch_uint_field(cs, 1, "underload")
      && pp.fetch_uint_field(cs, 1, "overload")
      && pp.field("proc_info")
      && t_ProcessedInfo.print_skip(pp, cs)
      && pp.close();
}

const ExtraCollatedData t_ExtraCollatedData;
...
const Maybe t_Maybe_uint64{t_uint64};
const Maybe t_Maybe_MsgMetadata{t_MsgMetadata};
...
const HashmapE t_HashmapE_64_EnqueuedMsg{64, t_EnqueuedMsg};
const UInt t_uint48{48};
const HashmapAugE t_HashmapAugE_256_AccountDispatchQueue_uint64{256, t_AccountDispatchQueue, t_uint64};
const Maybe t_Maybe_uint48{t_uint48};
const Maybe t_Maybe_OutMsgQueueExtra{t_OutMsgQueueExtra};
...
const RefT t_Ref_TYPE_1620{t_Transaction_aux};
...
const RefT t_Ref_TYPE_1632{t_TrComputePhase_aux};
...
const RefT t_Ref_TYPE_1646{t_ShardStateUnsplit_aux};
...
const RefT t_Ref_TYPE_1658{t_TYPE_1658};
const RefT t_Ref_TYPE_1659{t_TYPE_1659};
const NatWidth t_natwidth_3{3};
const RefT t_Ref_TYPE_1663{t_ShardDescr_aux};
...
const RefT t_Ref_TYPE_1677{t_McStateExtra_aux};
...
const RefT t_Ref_TYPE_1685{t_McBlockExtra_aux};
...
const HashmapE t_HashmapE_256_PrecompiledSmc{256, t_PrecompiledSmc};
...
const RefT t_Ref_TYPE_1736{t_VmGasLimits_aux};
...
bool register_simple_types(std::function<bool(const char*, const TLB*)> func) {
  return func("Unit", &t_Unit)
      ...
      && func("MsgMetadata", &t_MsgMetadata)
      ...
      && func("AccountDispatchQueue", &t_AccountDispatchQueue)
      && func("DispatchQueue", &t_DispatchQueue)
      && func("OutMsgQueueExtra", &t_OutMsgQueueExtra)
      ...
      && func("Block", &t_Block)
      && func("BlockRelaxed", &t_BlockRelaxed)
      ...
      && func("ImportedMsgQueueLimits", &t_ImportedMsgQueueLimits)
      ...
      && func("PrecompiledSmc", &t_PrecompiledSmc)
      && func("PrecompiledContractsConfig", &t_PrecompiledContractsConfig)
      ...
      && func("ExtraCollatedData", &t_ExtraCollatedData)
